...
import ltd.pchardware.mall.api.mall.vo.SecondLevelCategoryVO;
import ltd.pchardware.mall.api.mall.vo.ThirdLevelCategoryVO;
import ltd.pchardware.mall.common.Constants;
import ltd.pchardware.mall.common.MallCategoryLevelEnum;
import ltd.pchardware.mall.common.ServiceResultEnum;
import ltd.pchardware.mall.dao.GoodsCategoryMapper;
import ltd.pchardware.mall.entity.GoodsCategory;
...
public class MallCategoryServiceImpl implements MallCategoryService {
    ...
    public String saveCategory(GoodsCategory goodsCategory) {
        ...
        if (temp != null && !temp.getCategoryId().equals(goodsCategory.getCategoryId()) && temp.getParentId().equals(goodsCategory.getParentId())) {
    ...
    public String updateGoodsCategory(GoodsCategory goodsCategory) {
        ...
        if (temp2 != null && !temp2.getCategoryId().equals(goodsCategory.getCategoryId()) && temp2.getParentId().equals(goodsCategory.getParentId())) {
            //同名且不同id 不能继续修改
            return ServiceResultEnum.SAME_CATEGORY_EXIST.getResult();
        }
