...
import ltd.pchardware.mall.api.mall.param.SaveOrderParam;
import ltd.pchardware.mall.api.mall.vo.NewBeeMallOrderDetailVO;
import ltd.pchardware.mall.api.mall.vo.NewBeeMallOrderListVO;
...
import ltd.pchardware.mall.config.annotation.TokenToMallUser;
import ltd.pchardware.mall.api.mall.vo.NewBeeMallShoppingCartItemVO;
import ltd.pchardware.mall.entity.MallUser;
import ltd.pchardware.mall.entity.MallUserAddress;
import ltd.pchardware.mall.service.MallOrderService;
import ltd.pchardware.mall.service.MallShoppingCartService;
import ltd.pchardware.mall.service.MallUserAddressService;
...
public class MallOrderAPI {
    ...
    public Result<String> saveOrder(@ApiParam(value = "订单参数") @RequestBody SaveOrderParam saveOrderParam, @TokenToMallUser MallUser loginMallUser) {
        ...
        List<NewBeeMallShoppingCartItemVO> itemsForSave = mallShoppingCartService.getCartItemsForSettle(Arrays.asList(saveOrderParam.getCartItemIds()), loginMallUser.getUserId());
